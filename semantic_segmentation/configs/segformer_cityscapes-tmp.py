...
param_scheduler = [
    ...
    dict(begin=1500, by_epoch=False, end=80000, eta_min=0.0, power=1.0, type="PolyLR"),
]
...
train_dataloader = dict(
    batch_size=3,
    dataset=dict(
        ann_file="/mnt/aurora/km/models/cityscapes/scaling/uncompressed/uncompressed_s119988000_seed1.txt",
        data_prefix=dict(img_path="leftImg8bit/train", seg_map_path="gtFine/train"),
        data_root="/mnt/aurora/km/datasets/cityscapes/",
        pipeline=[
            dict(type="LoadImageFromFile"),
            dict(distance=0, distance_map=None, type="JXLTransform"),
            dict(type="LoadAnnotations"),
            dict(
                keep_ratio=True,
                ratio_range=(
...
work_dir = "/mnt/aurora/km/models/cityscapes/scaling/uncompressed/s119988000_seed1"
